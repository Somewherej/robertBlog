...
<template>
        <div class="detailBox tcommonBox" >
            <header>
              <el-button>{{detailObj.categoryName}}</el-button>
                <h1>
                ...
                <h2>
                  <i class="el-icon-date"></i>&nbsp<span >{{detailObj.createTime}}</span>
                   &nbsp&nbsp
                  <i class="fa fa-fw fa-eye"></i>&nbsp<span >{{detailObj.viewCount}}</span>
                </h2>
            </header>
